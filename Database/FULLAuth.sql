...
-- Dumping data for table auth.account: ~4 rows (approximately)
/*!40000 ALTER TABLE `account` DISABLE KEYS */;
INSERT INTO `account` (`id`, `username`, `sha_pass_hash`, `sessionkey`, `v`, `s`, `totp_secret`, `email`, `reg_mail`, `joindate`, `last_ip`, `last_attempt_ip`, `failed_logins`, `locked`, `lock_country`, `last_login`, `online`, `expansion`, `mutetime`, `mutereason`, `muteby`, `locale`, `os`, `recruiter`) VALUES
	(1, 'FLANNEL', '0E3ED87A0B5FDA4CD7C1B861E3D5F0090FAF8CBC', '57FAD5476211C7127BD7A41ACF5DDC5ABC5E6C543D7696F38F62300EA16F01CD12E036B96C457212', '43B4FCD0BD66D4719B9E64C8A47EA0D7BD2782A997D7DBC97F0D2529A94F3782', 'C9F411E832C812EEBB732ACA292FE824EE7F57922A452585FA518DF0B7D9711D', NULL, '', '', '2019-09-03 18:46:22', '25.4.94.196', '25.4.94.196', 0, 0, '00', '2019-09-15 14:28:04', 0, 2, 0, '', '', 0, 'Win', 0),
	(3, 'GHOST', '51D6CB48A69E307DF8470386F0C2B605F07338B8', '4C6F8B1D54EB6D92B7D035F09A3166134AAD2A94419001220BF878CD2BDE3FAD33D57EA8C6118D64', '0D0CB31E7D5033F208A97679D7C250DC1C042284FD3D7B5B0E34F31796CA9100', '9EB719CD2AD9151F4CB2C7F972C881093EB8875D61075163DFD892DCC1E618B9', NULL, '', '', '2019-09-03 22:09:31', '25.11.188.37', '25.11.188.37', 0, 0, '00', '2019-09-04 01:23:20', 0, 2, 0, '', '', 0, 'Win', 0),
	(4, 'DANTE', '7975AB15E201D5249052D83797500263EC2150B1', 'E6ACEE8492487516A1B677CF2261D6D3C1E3AC281EDDF26107A7BD36BB295D2877C4B16F475B6B9E', '8933A54BC76233E8A3E5523C9D228956E6F839A9A56817A5881BC546E6817575', '8B12CCED9124642A9D76EFCF7FCD61625109F3DAA2A2758DD56726A32EF172A3', NULL, '', '', '2019-09-03 22:09:47', '25.56.137.78', '25.56.137.78', 0, 0, '00', '2019-09-15 13:50:31', 0, 2, 0, '', '', 0, 'Win', 0),
	(6, 'TESTER', 'F5C35CB4AA7AFD6E42457C879AE09D5BD84DBD9A', '0129C6B3378CCC2E3F477677315A625FCCF774619A26E8B830C8E5F11EEE6E1CFEBB408DD5CEB903', '1DF4940DE3218962AB877EE69320878091EDFE261323B505D4D9597941821F0F', 'E22FC6D035CCF4748620C2FF62C62D5A9019FB2F869574763D8918D2B33D0BE3', NULL, '', '', '2019-09-15 13:51:58', '25.56.137.78', '25.56.137.78', 0, 0, '00', '2019-09-15 14:32:56', 0, 2, 0, '', '', 0, 'Win', 0);
...
-- Dumping data for table auth.account_muted: ~0 rows (approximately)
...
-- Dumping structure for table auth.character_logs
...
-- Dumping data for table auth.character_logs: ~0 rows (approximately)
/*!40000 ALTER TABLE `character_logs` DISABLE KEYS */;
INSERT INTO `character_logs` (`account`, `GUID`, `classID`, `level`) VALUES
	(1, 11, 21, 80),
	(1, 32, 0, 80),
	(1, 34, 0, 80),
	(4, 14, 0, 80),
	...
	(6, 31, 0, 80),
	(6, 33, 0, 80);
/*!40000 ALTER TABLE `character_logs` ENABLE KEYS */;
...
-- Dumping data for table auth.logs_ip_actions: ~0 rows (approximately)
...
-- Dumping data for table auth.rbac_linked_permissions: ~648 rows (approximately)
...
-- Dumping data for table auth.rbac_permissions: ~668 rows (approximately)
...
-- Dumping data for table auth.realmcharacters: ~5 rows (approximately)
...
INSERT INTO `realmlist` (`id`, `name`, `address`, `localAddress`, `localSubnetMask`, `port`, `icon`, `flag`, `timezone`, `allowedSecurityLevel`, `population`, `gamebuild`) VALUES
	(1, '21 Class Test Server', '25.4.94.196', '127.0.0.1', '255.255.255.0', 8085, 0, 0, 1, 0, 0, 12340);
...
-- Dumping data for table auth.secret_digest: ~0 rows (approximately)
...
-- Dumping data for table auth.updates: 55 rows
/*!40000 ALTER TABLE `updates` DISABLE KEYS */;
INSERT INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2014_11_10_00_auth.sql', '0E3CB119442D09DD88E967015319BBC8DAFBBFE0', 'ARCHIVED', '2014-11-09 19:00:00', 0),
	('2014_11_10_01_auth.sql', '327E77A1DA3546D5275AB249915DD57EDD6FDD3D', 'ARCHIVED', '2014-11-09 19:00:01', 0),
	('2014_12_10_00_auth.sql', '821703A96D80F9080074852B5A46E2909C9562EA', 'ARCHIVED', '2014-12-09 19:00:00', 0),
	('2014_12_21_00_auth.sql', 'CE2E5D2CD82E79C25294539ADED27A1429105B43', 'ARCHIVED', '2014-12-20 19:00:00', 0),
	('2015_03_20_00_auth.sql', 'E8C5B74BB45F0F35DEC182C72BACF435C7066FB0', 'ARCHIVED', '2015-03-19 20:00:00', 0),
	('2015_03_20_01_auth.sql', '862961815354DA2746F5F71FBC8155F57CBE75AB', 'ARCHIVED', '2015-03-19 20:00:01', 0),
	('2015_03_20_02_auth.sql', '33E4F94086590768EF5D4855DD43D7DE7C06ADA4', 'ARCHIVED', '2015-03-19 20:00:02', 0),
	('2015_08_21_00_auth.sql', 'C31A9E1D28E11B60BE8F8198637DD51F6D75123F', 'ARCHIVED', '2015-08-20 20:00:00', 0),
	('2015_11_07_00_auth.sql', '0ACDD35EC9745231BCFA701B78056DEF94D0CC53', 'ARCHIVED', '2015-11-06 19:00:00', 0),
	('2016_01_13_00_auth.sql', '24615CC69B3CD7BB4699874647C35BA86E8A93FD', 'ARCHIVED', '2016-01-12 19:00:00', 0),
	('2016_04_11_00_auth.sql', '0ACDD35EC9745231BCFA701B78056DEF94D0CC53', 'ARCHIVED', '2016-04-10 20:00:00', 0),
	('2016_05_11_00_auth.sql', '95B66235B8D67BF1CA216EB09F313C1F8F393B47', 'ARCHIVED', '2016-05-10 20:00:00', 0),
	('2016_06_06_00_auth.sql', 'A0A8D73A952D0618833416513D53F73A70E7EA25', 'ARCHIVED', '2016-06-05 20:00:00', 0),
	('2016_09_22_00_auth.sql', '70047954E3556BFA430ADD5680EF8797F74A4B9E', 'ARCHIVED', '2016-09-21 20:00:00', 0),
	('2016_10_16_00_auth.sql', '0ACDD35EC9745231BCFA701B78056DEF94D0CC53', 'ARCHIVED', '2016-10-15 20:00:00', 0),
	('2017_01_06_00_auth.sql', '6CCFE6A9774EC733C9863D36A0F15F3534189BBD', 'ARCHIVED', '2017-01-05 19:00:00', 0),
	('2017_01_08_00_auth.sql', 'A68511D0BF94C41F720A11B630CCB36BBEA6B17D', 'ARCHIVED', '2017-01-07 19:00:00', 0),
	('2017_02_06_00_auth_335.sql', '612068198F744892ECC0ACFE3BDCB6D72995916E', 'ARCHIVED', '2017-02-05 19:00:00', 0),
	('2017_03_17_00_auth.sql', '4902E9B1B063F399F928C2DD7AFD60427738E227', 'ARCHIVED', '2017-03-16 20:00:00', 0),
	('2017_04_19_00_auth.sql', 'EAE1C1D3AA752259785C056A8F18515E1EF32BC9', 'ARCHIVED', '2017-04-18 20:00:00', 0),
	('2017_05_29_00_auth.sql', '74BBB703AABD8A6BCB905EA2F5C14A5E26124CDD', 'ARCHIVED', '2017-05-28 20:00:00', 0),
	('2017_06_12_00_auth.sql', '176532AED785F1F759382C79A28E0FED92E99779', 'ARCHIVED', '2017-06-11 20:00:00', 0),
	('2017_06_12_01_auth.sql', '661B4935E101AF188BEBF43203144104E89F8C54', 'ARCHIVED', '2017-06-11 20:00:01', 0),
	('2017_06_12_02_auth.sql', '166F059E411FAA4901BBBA09A41EF07B1CADC4B6', 'ARCHIVED', '2017-06-11 20:00:02', 0),
	('2017_06_17_00_auth.sql', '4A172895CB9DA8EFE1270434D6ECB22D4F4DCB17', 'ARCHIVED', '2017-06-16 20:00:00', 0),
	('2017_06_28_00_auth.sql', 'D32EF80F57F629C23395D80F06E91D7E40719F83', 'ARCHIVED', '2017-06-27 20:00:00', 0),
	('2017_08_01_00_auth.sql', '6ECE808AF52345177189E962C0606B769B6806A6', 'ARCHIVED', '2017-07-31 20:00:00', 0),
	('2017_10_13_00_auth.sql', '87674E0D166AC60E3725B445714427892E42C6FE', 'ARCHIVED', '2017-10-12 20:00:00', 0),
	('2017_10_29_00_auth.sql', 'F742569F56BB29CE9C8DBBD40A6AB474F846485C', 'ARCHIVED', '2017-10-28 20:00:00', 0),
	('2017_12_17_00_auth.sql', '2CD99730D4D32DBF0584CD5B1AA6F8F4AE3DA975', 'ARCHIVED', '2017-12-16 19:00:00', 0),
	('2018_01_03_00_auth_2018_01_02_00_auth.sql', '08AF5DAB45515B681B738DA17FA414C7C7CCA44E', 'ARCHIVED', '2018-01-02 19:00:00', 0),
	('2018_01_09_00_auth.sql', 'A5D4EC8FCFAB4F2DCE70EDCAD1ACBFB484FD68D5', 'ARCHIVED', '2018-01-08 19:00:00', 0),
	('2018_01_24_00_auth.sql', '167B17D8A253D62A8112F8A7EB21C6E99CAEF1E4', 'ARCHIVED', '2018-01-23 19:00:00', 0),
	('2018_02_19_00_auth.sql', '80E50F9C7F1EE7BA62789EA4C4F009170B79E6C9', 'ARCHIVED', '2018-02-18 19:00:00', 0),
	('2018_03_06_00_auth.sql', '2D71E93DF7419A30D0D21D8A80CF05698302575A', 'ARCHIVED', '2018-03-05 19:00:00', 0),
	('2018_03_08_00_auth.sql', '624C58A07E0B4DDC4C1347E8BA8EFEEFD5B43DA7', 'ARCHIVED', '2018-03-07 19:00:00', 0),
	('2018_06_23_00_auth.sql', 'BE35312C386A127D047E5A7CE0D14DB41D905F8E', 'ARCHIVED', '2018-06-22 20:00:00', 0),
	('2018_08_30_00_auth.sql', '22F69864361D3E72F800379338310172C0576D1C', 'ARCHIVED', '2018-08-29 20:00:00', 0),
	('2018_09_06_00_auth.sql', '309D21E0DF82ED8921F77EAFDE741F38AC32BB13', 'ARCHIVED', '2018-09-05 20:00:00', 0),
	('2018_09_17_00_auth.sql', '4DB671F0A4FA1A93AF28FB6426AF13DE72C7DA3D', 'ARCHIVED', '2018-09-16 20:00:00', 0),
	('2018_12_30_00_auth.sql', '680F4F9194FC37592041C2DB5B2B7006B14E836D', 'ARCHIVED', '2018-12-29 19:00:00', 0),
	('2019_03_19_00_auth.sql', '03BA8CFC60ACD5B874840A3E50F11CD2643730A0', 'ARCHIVED', '2019-03-18 20:00:00', 0),
	('2019_04_15_00_auth.sql', 'EC67389946A24BFAA226B9DFCFEDB3BA095B4C42', 'ARCHIVED', '2019-04-14 20:00:00', 0),
	('2019_04_27_00_auth.sql', '84B1EB9CC9B09BAF55E6295D202EC57D99B1B60E', 'ARCHIVED', '2019-04-26 20:00:00', 0),
	('2019_05_15_00_auth.sql', '8A7B96E66D689DA63380654142FF60A1EE938697', 'ARCHIVED', '2019-05-14 20:00:00', 0),
	('2019_06_06_00_auth.sql', '6DE8159E04BEE7BA0A4A81D72D160EB74934B6A5', 'ARCHIVED', '2019-06-05 20:00:00', 0),
	('2019_06_15_00_auth.sql', '456B92D99FFD2E7B6CBF64F4C68555A42B24B298', 'ARCHIVED', '2019-06-14 20:00:00', 0),
	('2019_06_16_00_auth.sql', 'B14AED4D3387B56FF8C8161D3671750AEEAE0F2E', 'ARCHIVED', '2019-06-15 20:00:00', 0),
	('2019_06_21_00_auth.sql', 'C519239830204B68E710F698BC0C9E89B6D5FD24', 'ARCHIVED', '2019-06-20 20:00:00', 0),
	('2019_07_15_00_auth.sql', '64B491CD197A4466D7F739D67DD30C9502FF393A', 'ARCHIVED', '2019-07-14 20:00:00', 0),
	('2019_07_16_00_auth.sql', '36CB53A9EBD64BFDCF7030083E36E534F1753773', 'ARCHIVED', '2019-07-15 20:00:00', 0),
	('2019_07_17_00_auth.sql', '4F983F039904894ACC483BE885676C5F0A18F06B', 'ARCHIVED', '2019-07-16 20:00:00', 0),
	('2019_08_10_00_auth.sql', 'E936802893474BB9B459D01BB5F181F54EDF0653', 'ARCHIVED', '2019-08-09 20:00:00', 0),
	('2019_08_10_01_auth.sql', 'C58357260F0C70DA226A71F7E05DE2C49AAEFD74', 'ARCHIVED', '2019-08-09 20:00:00', 0),
	('2019_08_16_00_auth.sql', '99CF9C250EFBBD703DF0A2D1BDEB1E46D1063EE9', 'RELEASED', '2019-08-16 02:25:07', 0);
...
-- Dumping data for table auth.updates_include: 3 rows
...
INSERT INTO `uptime` (`realmid`, `starttime`, `uptime`, `maxplayers`, `revision`) VALUES
	(1, 1567549587, 656, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1567550604, 0, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1567551165, 0, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1567552589, 943, 1, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1567553710, 0, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1567554472, 3742, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1567558502, 0, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1567559763, 8565, 3, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1567568384, 63138, 2, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1568063081, 0, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1568068433, 2515, 1, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1568151529, 0, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1568153248, 0, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1568154067, 0, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1568154572, 4965, 1, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1568569554, 9843, 2, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)'),
	(1, 1572056975, 0, 0, 'TrinityCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, RelWithDebInfo, Static)');
...
CREATE TABLE `vw_log_history` (
	...
	`Occurrences` BIGINT(21) NOT NULL,
	`Realm` VARCHAR(32) NULL COLLATE 'utf8_general_ci',
	`type` VARCHAR(250) NOT NULL COLLATE 'utf8_general_ci',
