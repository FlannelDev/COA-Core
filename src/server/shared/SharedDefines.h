...
CLASS_DRAGONKNIGHT = 12, //-Class  custom class list
CLASS_WITCHDOCTOR = 13,
CLASS_DEMONHUNTER = 14,
CLASS_WITCHHUNTER = 15,
CLASS_STORMBRINGER = 16,
CLASS_SPIRITMAGE = 17,
CLASS_ABOMINATION = 18,
CLASS_GUARDIAN = 19,
CLASS_SAMURAI = 20,
CLASS_WORGEN = 21,
CLASS_THIEF = 22,
...
CLASS_PYROMANCER = 27,
CLASS_CULTIST = 28,
CLASS_NECROMANCER = 29,
CLASS_SUNDANCER = 30,
CLASS_TINKER = 31,
CLASS_RIFTBLADE = 32,
CLASS_REAPER = 33,
CLASS_GROVEWARDEN = 34,
CLASS_TEMPLAR = 35,
CLASS_TIDECALLER = 36,
CLASS_DOOMCALLER = 37,
CLASS_HELLION = 38,
...
#define MAX_CLASSES       45 //-Class custom+base+1
//-Class classmask
...
#define CLASSMASK_ALL_PLAYABLE \
    ...
    (1<<(CLASS_DEATH_KNIGHT-1)) | (1<<(CLASS_DRAGONKNIGHT-1)) |(1<<(CLASS_WITCHDOCTOR-1))| (1<<(CLASS_DEMONHUNTER-1))| \
	...
	(1<<(CLASS_STARLORD-1))|(1<<(CLASS_LION-1))| (1<<(CLASS_FELMAGE-1))| \
    (1<<(CLASS_CHRONOMANCER-1))| (1<<(CLASS_TIMELORD-1))| (1<<(CLASS_DARKRANGER-1)))
...
{
    switch (QuestSort) //-Class used for class quests. (still needed)
    {
...
enum SpellFamilyNames
{
	...
	SPELLFAMILY_HELLION         = 44,  // 
	SPELLFAMILY_STARLORD         = 45,  // 
	SPELLFAMILY_LION         = 46,  // 
	SPELLFAMILY_FELMAGE         = 47,  // 
	SPELLFAMILY_CHRONOMANCER         = 48,  // 
	SPELLFAMILY_TIMELORD         = 49,  // 
	SPELLFAMILY_DARKRANGER        = 50  // 
